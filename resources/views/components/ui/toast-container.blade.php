...
>
    <template x-for="toast in toasts" :key="toast.id">
        <div
            ...
            class="flex items-center gap-3 bg-brand-navy toast-dark border border-brand-navy-700 text-white rounded-lg px-4 py-3 shadow-lg pointer-events-auto w-full"
            role="status"
        >
