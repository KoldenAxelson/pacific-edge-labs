<x-app-layout>
    ...
    >
        <button
            ...
            class="fixed bottom-6 right-4 z-30 w-10 h-10 bg-brand-navy dark-stable text-white rounded-full shadow-lg flex items-center justify-center active:scale-95 transition-smooth"
